...
class ArithmeticTermTest {
    ...
    void evaluate() {
        ...
        ArithmeticTerm arithmeticTerm4 = new ArithmeticTerm("8 4.0 / 10 + 6 / 2 ^ sqrt 2");
        ...
        ArithmeticTerm arithmeticTerm10 = new ArithmeticTerm("4.0 sqrt 2.0 3.0 ^ * 2.0 / ");
        ...
        assertEquals(8.0, arithmeticTerm10.evaluate());
    }

    @Test
    void convert() {
        ArithmeticTerm arithmeticTerm5 = new ArithmeticTerm("( ( 4.3 * 1e-1 ) - .4 )");
        ArithmeticTerm arithmeticTerm6 = new ArithmeticTerm("( ( ( ( ( 8 / 4 ) + 10 ) / 6 ) ^ 2 ) sqrt ) 2");
        ...
        assertEquals("8.0 4.0 / 10.0 + 6.0 / 2.0 ^ sqrt 2.0 ", arithmeticTerm6.convert());
